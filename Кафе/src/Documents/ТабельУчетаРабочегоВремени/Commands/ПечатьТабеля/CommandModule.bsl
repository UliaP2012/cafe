...
Процедура ОбработкаКоманды(ПараметрКоманды, ПараметрыВыполненияКоманды)
	...
	ПечатьТабеля(ТабДок, ПараметрКоманды);
...
//	ПараметрКоманды - Произвольный - содержит ссылку на объект, для которого вызвана команда печати.
&НаСервере
Процедура ПечатьТабеля(ТабДок, ПараметрКоманды)
	Документы.ТабельУчетаРабочегоВремени.ПечатьТабеля(ТабДок, ПараметрКоманды);
КонецПроцедуры
